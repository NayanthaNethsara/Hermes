...
## 3. Python environment & Project Management

Backend dependencies and packaging are configured in `src/backend/pyproject.toml` (PEP 621 / PEP 517).

### Option A: Using `uv` (Recommended)

```bash
# Sync virtual environment for backend
...
You can run both backend and frontend containerized without configuring local Python or Node environments:
