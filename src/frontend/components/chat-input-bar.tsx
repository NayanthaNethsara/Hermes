  ...
  return (
    <div className={`w-full max-w-2xl mx-auto ${className}`}>
      <form
        ...
        className="w-full rounded-2xl bg-[#161618] border border-white/10 p-3 shadow-xl flex flex-col justify-between focus-within:border-white/25 transition-colors"
      >
